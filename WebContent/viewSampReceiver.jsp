...
<body>
	<div class="wrapper">
		<div class="wrapper_inner">
			<%
				List<userVariable> list = UserQuery.getSampleReceiver();
			...
			<div class="main_container">
				...
				<div class="content"
					...
					<h3 style="margin-left: -12px;">Manage Sample Receiver</h3>
					<div class="row"
						style="background: #fff; height: 600px; padding: 80px 50px 50px 50px; overflow: auto;"
						class="table-responsive;">
						<!-- Content -->
						<%
							if (session.getAttribute("updateRec") != null) {
						%>
						<span
						...
						%>
						<%
							if (session.getAttribute("addRec") != null) {
						%>
						<span
							style="margin: 0px 0px; text-align: center; font-size: 18px; color: green;">
							<script>
						...
						%>
						<%
							if (session.getAttribute("deleteRec") != null) {
						%>
						<span
							style="margin: 0px 0px; text-align: center; font-size: 18px; color: green;">
							<script>
						...
						<table class="table table-striped table-bordered"
							...
							<tbody>
								...
								<c:forEach items="${list}" var="u">
									...
									<tr>
										<td id="th"><a
											href="viewSampRecData.jsp?SID=${u.getSID()}"><i
										...
										<td id="th">
											...
											data-toggle="modal"
											data-target="#editSampReceiver<%out.print(count);%>"><i
												class="fa fa-edit"></i></a>
										</td>
										<td id="th"><a
											href="deleteSampReceiver.jsp?SID=${u.getSID()}"
											onclick="return Delete()"><i class="fa fa-trash-o"
												style="color: red;"></i></a></td>
									</tr>
									<div class="modal fade"
										id="editSampReceiver<%out.print(count);%>" role="dialog">
										<div class="modal-dialog modal-md">
											<div class="modal-content">
												<div class="modal-header">
													<button type="button" class="close" data-dismiss="modal">&times;</button>
													<h4 class="modal-title">Update Sample Receiver</h4>
												</div>
												<div class="modal-body">
													<div class="row">
														<div class="col-sm-12">
															<form action="updateReceiverHandler.jsp" method="POST">
																			...
																			<div class="form-group has-success has-feedback">
																				<div class="input-group">
																					<span class="input-group-addon"> <i
																						...
																						class="form-control"
																						required="">
																						<option value="${u.getTitle()}">${u.getTitle()}</option>
																...
																<div class="row">
																	<div class="col-sm-6">
																		<div class="form-group">
																			<label for="ticket_time"> <i id="star">*&nbsp</i>
																				Lab Name
																			</label>
																			<div class="form-group has-success has-feedback">
																				<div class="input-group">
																					<span class="input-group-addon"> <i
																						class="fa fa-user"></i>
																					</span> <input type="text" name="labID" id="username"
																						class="form-control" required="" value="ZLab01">
																				</div>
																			</div>
																		</div>
																	</div>
																			...
																			<div class="form-group">
																				...
																				<div class="form-group has-success has-feedback">
																					<div class="input-group">
																						<span class="input-group-addon"> <i
																							class="fa fa-lock"></i>
																						</span> <input type="text" name="password" id="Password"
	...
	<div class="modal fade" id="staffModal">
		<div class="modal-dialog modal-lg modal-dialog-right"
			...
			<div class="modal-content">
				...
				<!-- Modal body -->
				<div class="modal-body">
					<form action='directAddSampUser.jsp' method='POST'>
						<input type="text" name="signature" value="OK" hidden="" /> <input
							type="text" name="photo" value="OK" hidden="" />
						<div class="row">
							<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mbr-col">
								<div class="form-group">
							...
							<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mbr-col">
								<div class="form-group">
									<label for="">Date of Birth</label> <input type="date"
										...
										required="" style="padding: 0px 0px 8px 10px">
								</div>
							</div>
							<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mbr-col">
								<div class="form-group">
							...
							<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mbr-col">
								<div class="form-group">
									<label for="">Lab Name</label> <select id="" name="LabID"
										class="form-control mb-2 mr-sm-2 custom-select status"
										required="">
										<option value="ZLab01">Store</option>
									</select>
								</div>
							</div>
						</div>
				...
				<div class="modal-footer" style="padding: 4px;">
					<div style="text-align: center; color: #515151; font-size: 14px;">
						<p>Copyright &copy; Food And Drug Inspection</p>
					</div>
				</div>
			</div>
		</div>
...
%>
<%
	session.setAttribute("updateRec", null);
%>
<%
	session.setAttribute("addRec", null);
%>
<%
	session.setAttribute("deleteRec", null);
%>
</html>