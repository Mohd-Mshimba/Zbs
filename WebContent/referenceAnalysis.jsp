	...
	<div class="wrapper_inner">
		...
		<div class="main_container">
			...
			<div class="content"
				...
				<h3 style="margin-left: -12px;">All Approved Samples</h3>
				<div class="row"
					...
					<table class="table table-striped table-bordered"
						...
						<%
							...
							try {
								...
								String sql = "SELECT * FROM sample WHERE Remark!='Not yet' AND Approval!='Not yet'";
						...
						<tbody>
							...
							<tr>
								...
								<%
									String SCode = resultSet.getString("SCode").toString();
											Connection con = null;
											Statement stmt = null;
											ResultSet rs = null;
								...
								<td id="th">
									<%
										while (rs.next()) {
									%> <a href="ViewResultRef.jsp?SCode=<%=resultSet.getString("SCode")%>"><i
