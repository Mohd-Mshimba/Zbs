        ...
        <div class="wrapper_inner">
            ...
            <div class="main_container">
                ...
                <div class="content"
                    ...
                    <h3 style="margin-left: -12px;">View Current Step</h3>
                    <div class="row"
                        ...
                        <table class="table table-striped table-bordered"
                            ...
                            <thead style="text-align: center; background: #E3F2F1;">
                                <tr>
                                    ...
                                    <th id="th">Sabmission Date</th>
                                    <th id="th">Remark</th>
                                    <th id="th">Result Date</th>
                                    <th id="th">Approval</th>
                                    <th id="th">View Report</th>
                                </tr>
                            </thead>
                            <%
                                Connection connection = null;
                                        ...
                                        try {
                                            String ids = (String) session.getAttribute("username");
                                            connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/FINAL", "root", "");
                                            statement = connection.createStatement();
                                            String sql = "SELECT * FROM customer, sample WHERE(customer.CCode=sample.CCode AND customer.Email='"+ids+"') ";
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td id="th"><a
                                        href='CurrentStepRes.jsp?SCode=<%=resultSet.getString("SCode")%>'><i
                                            class="fa fa-book" style="color: green"></i></a></td>
                                </tr>
                                <%
                                    }
                                %>
